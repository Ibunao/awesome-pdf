...
- [PDFWatermark](https://pdfwatermark.top/) – Free browser-based tool to add text or PNG/JPG watermarks to PDFs. Files are processed locally; no uploads or account required.
